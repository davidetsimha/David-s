...
function GalleryTab() {
  ...
  return (
    <>
      ...
      {deleteId && (
        <Modal open={!!deleteId} onClose={() => setDeleteId(null)} title="Supprimer l image">
          <p className="text-gray-600 mb-6">Etes-vous sur de vouloir supprimer cette image ?</p>
...
function CreationsTab() {
  ...
  return (
    <>
      ...
      {deleteId && (
        <Modal open={!!deleteId} onClose={() => setDeleteId(null)} title="Supprimer la creation">
          <p className="text-gray-600 mb-6">Etes-vous sur de vouloir supprimer cette creation ?</p>
          <div className="flex gap-3">
            <Button variant="secondary" onClick={() => setDeleteId(null)} className="flex-1">Annuler</Button>
            <Button variant="danger" onClick={handleDelete} loading={deleteMutation.isPending} className="flex-1">
              Supprimer
