      ...
      <div className="space-y-3" dir={direction}>
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-stone-500">
              {t('orderHistory.reorderConfirm.replaceDesc', 'Vider le panier et ajouter ces articles')}
            </p>
          </div>
        </button>
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-stone-500">
              {t('orderHistory.reorderConfirm.mergeDesc', 'Ajouter ces articles au panier existant')}
            </p>
          </div>
        </button>
