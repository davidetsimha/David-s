...
export function AdminDeliveryZones() {
  const { data: zones, isLoading } = useDeliveryZones(false); // Get all zones including inactive
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmModal
        ...
        message="Etes-vous sur de vouloir supprimer cette zone de livraison ? Cette action est irreversible."
