  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="font-display text-2xl lg:text-3xl text-gray-900">Produits</h1>
          <p className="text-gray-500 mt-1">Gerez vos produits de patisserie</p>
        </div>
      ...
      <Modal open={modalOpen} onClose={closeModal} title={editProduct ? 'Modifier le produit' : 'Nouveau produit'}>
